...
public class Arvore {
    public Nodo raiz;
    public static Nodo sentinela = new Nodo(0, false); // Nodo sentinela. Todos os nodos no último nível da árvore apontarão para a sentinela
    // que é sempre de cor preta com valor 0
    public Integer cont;

    public Arvore() {
        this.raiz = Arvore.sentinela;
    }
    ...
    private void rotacao_esq(Nodo x) {
        Nodo y = x.dir;
        x.dir = y.esq;
        if (y.esq != Arvore.sentinela) y.esq.p = x;
        y.p = x.p;
        if (x.p == Arvore.sentinela) this.raiz = y;
    ...
    private void rotacao_dir(Nodo x) {
        Nodo y = x.esq;
        x.esq = y.dir;
        if (y.dir != Arvore.sentinela) y.dir.p = x;
        y.p = x.p;
        if (x.p == Arvore.sentinela) this.raiz = y;
        else if (x == x.p.esq) x.p.esq = y;
        else x.p.dir = y;
    ...
    public void remove(int n) {
        ...
        if(z.v == n) {
            if (z.esq == Arvore.sentinela) {
                x = z.dir;
                this.transplant(z, z.dir);
            } else if (z.dir == Arvore.sentinela) {
                x = z.esq;
    ...
    public void grafico() {
        ...
        this.raiz.grafico();
        System.out.println("\tNodo Sentinela [Cor = Preto];");
        System.out.println("}");
    }
